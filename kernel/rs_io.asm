...
;
; 19.jun.2019
; Code is rewritten from rs_io.s (GAS) to rs_io.asm 
...
rep_int:
	...
	push edx
	sub edx, 2
	call DWORD [eax * 2 + jmp_table]	; NOTE! not *4, bit0 is 0 already 
	pop edx
	jmp rep_int
end:
	mov al, 0x20
...
.2:	
	jmp .3
.3:	
	and al, 0xd			; disable transmit interrupt
	out dx, al
	ret
